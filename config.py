...
**parse_document 使用规则（严格遵守）**:
- search_kb 返回的每段内容已足够回答问题，**禁止**再调 parse_document
- **只有**用户明确说"分析这篇论文""详细介绍这篇文章""帮我读一下这篇"且指明了具体论文名称时，才调用 parse_document
- 以下场景**绝对禁止**调 parse_document：搜索某主题文献、浏览知识库、问某个领域有哪些论文、追问"还有吗"
